 ...
 * @author Lapoushko
 */
val VacancyNavType = object : NavType<VacancyItem>(isNullableAllowed = false) {
    override fun get(bundle: Bundle, key: String): VacancyItem {
        return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            bundle.getParcelable(key, VacancyItem::class.java) as VacancyItem
        } else {
    ...
    override fun put(bundle: Bundle, key: String, value: VacancyItem) {
